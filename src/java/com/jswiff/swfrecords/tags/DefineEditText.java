 ...
 * variable the contents of the text field are stored in and kept in sync with.
 * </p>
 * 
 * <p>
 ...
 * <code>DefineFont</code>). If the <code>useOutlines</code> flag is cleared,
 * the Flash Player will try to render text using device fonts rather than glyph
 * fonts.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * <li>
 * <code>target</code>: a window name</li>
 * </ul>
 * 
 * </li>
 * <li>
 ...
 * <ul>
 * <li>
 * <code>face</code>: font name supplied in a <code>DefineFont2</code> tag.</li>
 * <li>
 * <code>size</code> in twips (1/20 px). Leading <code>+</code> or
 * <code>-</code> indicates a relative size</li>
 * <li>
 * <code>color</code> as a <code>#RRGGBB</code> hex value</li>
 * </ul>
 * 
 * </li>
 * <li>
 * <code>&lt;b&gt;...&lt;/b&gt;</code>: bold text</li>
 * <li>
 * <code>&lt;i&gt;...&lt;/i&gt;</code>: italic text</li>
 * <li>
 * <code>&lt;u&gt;...&lt;/u&gt;</code>: underlined text</li>
 * <li>
 ...
 * <ul>
 * <li>
 * <code>leftmargin</code> in twips (1/20 px)</li>
 * <li>
 * <code>rightmargin</code> in twips</li>
 * <li>
 * <code>indent</code> in twips</li>
 * <li>
 * <code>blockindent</code> in twips</li>
 * <li>
 * <code>leading</code> in twips</li>
 * <li>
 * <code>tabstops</code>: comma-separated list in twips</li>
 * </ul>
 * 
 * </li>
 * <li>
 * <code>&lt;tab&gt;</code>: advances to next tab stop (defined with
 * <code>&lt;textformat&gt;</code>)</li>
 * </ul>
 * </p>
 * 
 * <p>
...
public final class DefineEditText extends DefinitionTag {
   ...
   * 
   * @param characterId
   *          character ID of the text field
   * @param bounds
   *          the size of the rectangle which completely encloses the text
   *          field.
   * @param variableName
   *          variable name (in dot or slash syntax)
   */
  public DefineEditText(int characterId, Rect bounds, String variableName) {
    super(TagType.DEFINE_EDIT_TEXT);
  ...
  /**
   * Checks if the <code>autoSize</code> flag is set, i.e. if the text field is
   * supposed to resize depending on its content size.
   * 
  ...
  /**
   * Sets the value of the <code>border</code> flag. A set flag causes a border
   * to be drawn around the text field.
   * 
   * @param border
   *          <code>true</code> if flag set, else <code>false</code>
   */
  ...
  /**
   * Checks if the <code>border</code> flag, causing a border to be drawn around
   * the text field.
   * 
  ...
  /**
   * Returns the bounds of the text field, i.e. the size of the rectangle which
   * completely encloses the text field.
   * 
  ...
  /**
   * Sets the value of the <code>html</code> flag. If set, html tags are allowed
  ...
  /**
   * Returns the <code>html</code> flag, which specifies whether html tags are
  ...
  /**
   * Returns the initial text string. Check with <code>hasText()</code> first if
   * value is set.
   * 
   * @return initial text
   */
  ...
  /**
   * Sets the layout properties of the text: alignment, margins, indentation and
   * line spacing.
   * 
   * @param align
   *          text alignment, one of the constants <code>ALIGN_LEFT,
   * 		  ALIGN_RIGHT, ALIGN_CENTER, ALIGN_JUSTIFY</code>
   * @param leftMargin
   *          left text margin in twips (i.e. 1/20 px)
   * @param rightMargin
   *          right text margin
   * @param indent
   *          text indentation in twips
   * @param leading
  ...
  /**
   * Returns the text leading (line spacing) in twips (i.e. 1/20 px). Check with
   * <code>hasLayout()</code> first if value is set.
   * 
  ...
  /**
   * Sets the value of the <code>multiLine</code> flag. If set, the text field
  ...
  /**
   * Sets the value of the <code>noSelect</code> flag. If set, the text cannot
  ...
  /**
   * Checks if the <code>noSelect</code> flag is set. If set, the text cannot be
   * interactively selected (and copied).
   * 
  ...
  /**
   * Sets the value of the <code>password</code> flag. If set, the characters of
   * the text are displayed as asterisks.
   * 
   * @param password
   *          <code>true</code> if flag set, else <code>false</code>
   */
   ...
   * Player tries to use device fonts rather than glyph fonts.
   * 
   * @return <code>true</code> if <code>useOutlines</code> flag set, otherwise
   *         <code>false</code>
   */
  ...
  /**
   * Sets the name of the variable the contents of the text field are stored in
  ...
  /**
   * Returns the name of the variable the contents of the text field are stored
  ...
  /**
   * Checks if the <code>wordWrap</code> flag is set. If set, the text will wrap
